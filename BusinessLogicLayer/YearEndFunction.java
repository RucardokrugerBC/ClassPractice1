...
public class YearEndFunction implements Events {
    ...
    public YearEndFunction(String eventType, String eventDateandTime, String eventCity, String eventArea,
            String eventStreet, String eventAdress, String eventHuoseNumber, String eventTheme, int numberOfAdults,
            int numberOfChildren, List<String> menu) {
